...
class Content
{
	...
	/**
     * @ORM\ManyToOne(targetEntity="Softlogo\OkulskiBundle\Entity\Offer")
     */
    private $offer;
     ...
     * Set offer
     *
     * @param \Softlogo\OkulskiBundle\Entity\Offer $offer
     *
     * @return Content
     */
    public function setOffer(\Softlogo\OkulskiBundle\Entity\Offer $offer = null)
    {
        $this->offer = $offer;
     ...
     * Get offer
     *
     * @return \Softlogo\OkulskiBundle\Entity\Offer
     */
