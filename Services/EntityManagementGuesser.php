...
class EntityManagementGuesser
{
	...
	public function initialize(\Symfony\Bundle\FrameworkBundle\Controller\Controller $controller)
	{
	 ...
	 * @return string
	 */
	public function getBundleShortcut()
	{
		return str_replace('Bundle', '', $this->getBundleShortName());
	}
