...
class TwigSocialBar extends \Twig_Extension{
    ...
    public function getSocialButtons($parameters = array())
    {
      ...
      return $this->container->get('softlogo.socialBarHelper')->socialButtons($render_parameters);
    }
    ...
    public function getFacebookLikeButton($parameters = array())
    {
       ...
       return $this->container->get('softlogo.socialBarHelper')->facebookButton($parameters);
    }
    ...
    public function getTwitterButton($parameters = array())
    {
       ...
       return $this->container->get('softlogo.socialBarHelper')->twitterButton($parameters);
    }
    ...
    public function getGooglePlusButton($parameters = array())
    {
       ...
       return $this->container->get('softlogo.socialBarHelper')->googlePlusButton($parameters);
    }
}
