...
use Softlogo\CMSBundle\Entity\Type;
use Softlogo\CMSBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SoftlogoCMSBundle:Type')->findAll();

        return $this->render('SoftlogoCMSBundle:Type:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SoftlogoCMSBundle:Type:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SoftlogoCMSBundle:Type')->find($id);
        ...
        return $this->render('SoftlogoCMSBundle:Type:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SoftlogoCMSBundle:Type:edit.html.twig', array(
            'entity'      => $entity,
